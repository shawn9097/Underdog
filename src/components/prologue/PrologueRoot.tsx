...
/**
 * CAME BACK WRONG — kinetic prologue cinema.
 *
 * The locked Season-1 prologue (PROLOGUE, 29 verbatim paragraphs) rendered as
 * scroll-paced kinetic-typography cinema. Long-form fiction first, effects
 * second: the read stays comfortable at a ~65ch measure with an immaculate rag.
 *
...
import { PROLOGUE, TRACKS } from "@/lib/album";
import { BEATS } from "./beats";
import Finale from "./Finale";
import Paragraph from "./Paragraph";
import Pulse, { type PulseHandle } from "./Pulse";

export default function PrologueRoot() {
  ...
  return (
    <div className="pl" ref={rootRef}>
      ...
      <Pulse reduced={reduced} handleRef={pulseRef} />

      <div className="pl-hud" data-pl-hud aria-hidden="true">
        <span className="pl-hud-lv">LV -0060</span>
        <span>SVC-CORRIDOR</span>
      ...
      <article className="pl-article" data-pl-article>
        <header className="pl-open">
          <p className="pl-open-kicker">Underdog City · Season One Prologue</p>
          <h1 className="pl-open-title">
            CAME BACK{" "}
            <span className="pl-glitch" data-text="WRONG">
              WRONG
            </span>
          </h1>
          <p className="pl-open-sub">{TRACKS[11].role}</p>
